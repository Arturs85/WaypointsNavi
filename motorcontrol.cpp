...
MotorControl::MotorControl(double track, double wheelRadius)
{
    ...
    maxAllowedWheelSpeedDeltaRadSec = 1500* TrajectoryExecutor::acc*Control::linVelUpdatePeriodSec/wheelRadius; // for final check before sending next wheel speeds
