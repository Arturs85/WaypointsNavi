#ifndef GPSUDPRECEIVER_HPP
#define GPSUDPRECEIVER_HPP
...
class GpsUdpReceiver{
public:

    static pthread_t receivingThread;
    static const int receivingPort = 45555;
    static const int sendingPort = 45557;
