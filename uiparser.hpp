...
public:
    enum UiMsgs {MODE_MANUAL, MODE_AUTO, CLEAR_WAYPOINTS, ADD_WAYPOINT, CONTROL, GYRO_DIR, SAVE_WAYPOINTS, PAUSE, RESUME,PID,ADD_FOTOPOINT,STEP_RESPONSE,SHUTDOWN,SEND_NAMES,OPEN_FILE,USE_ULTRA,IGNORE_ULTRA,FROM_STRING, SEND_POINT, MODIFY_POINT,INSERT_AFTER, UNKNOWN};
