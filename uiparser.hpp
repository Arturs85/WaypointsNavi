...
public:
    enum UiMsgs {MODE_MANUAL, MODE_AUTO, CLEAR_WAYPOINTS, ADD_WAYPOINT, CONTROL, GYRO_DIR, SAVE_WAYPOINTS, PAUSE, RESUME,PID,ADD_FOTOPOINT,STEP_RESPONSE,SHUTDOWN,SEND_NAMES,OPEN_FILE, UNKNOWN};
